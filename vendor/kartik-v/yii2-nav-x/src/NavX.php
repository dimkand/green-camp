...
class NavX extends Widget
{
    ...
    public static function registerDropDownOnHoverScript()
    {
        $script = <<<EOP

                $('.nav li.dropdown').hover(

                     function() { $(this).find('.dropdown-menu').first().stop(true, true).show(); },

                     function() { $(this).find('.dropdown-menu').first().stop(true, true).hide(); }
